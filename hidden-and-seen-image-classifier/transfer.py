...
parser.add_argument('--parent_dir', default=os.path.expanduser(os.environ['USERPROFILE']), help='path to experiments and data folder')
parser.add_argument('--data_dir', default='data', help="Directory containing the destination dataset")
parser.add_argument('--model_dir', default='experiments',
                    help="Directory containing old network to transfer")
parser.add_argument('--restore_file', default='best',
                    help="Optional, name of the file in --model_dir containing weights to reload before \
                    training")  # 'best' or 'train'
# added by me
parser.add_argument('--model_out_dir', default='experiments',
                    help="Directory to write transfer results and containing params.json")
