...
parser.add_argument('--data_dir', default='./data', help="Directory containing the dataset")  # './data/grayscale-data'
parser.add_argument('--model_dir', default='experiments', help="Directory containing trained network")
